...
const (
	SensorService_CreateSensor_FullMethodName = "/benchlab.sensor.v1.SensorService/CreateSensor"
	SensorService_GetSensor_FullMethodName    = "/benchlab.sensor.v1.SensorService/GetSensor"
	SensorService_ListSensors_FullMethodName  = "/benchlab.sensor.v1.SensorService/ListSensors"
	SensorService_UpdateSensor_FullMethodName = "/benchlab.sensor.v1.SensorService/UpdateSensor"
	SensorService_DeleteSensor_FullMethodName = "/benchlab.sensor.v1.SensorService/DeleteSensor"
)
...
type SensorServiceClient interface {
	...
	UpdateSensor(ctx context.Context, in *UpdateSensorRequest, opts ...grpc.CallOption) (*Sensor, error)
	DeleteSensor(ctx context.Context, in *SensorId, opts ...grpc.CallOption) (*DeleteSensorResponse, error)
}
...
func (c *sensorServiceClient) CreateSensor(ctx context.Context, in *CreateSensorRequest, opts ...grpc.CallOption) (*Sensor, error) {
...
func (c *sensorServiceClient) GetSensor(ctx context.Context, in *SensorId, opts ...grpc.CallOption) (*Sensor, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Sensor)
...
func (c *sensorServiceClient) UpdateSensor(ctx context.Context, in *UpdateSensorRequest, opts ...grpc.CallOption) (*Sensor, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Sensor)
...
func (c *sensorServiceClient) DeleteSensor(ctx context.Context, in *SensorId, opts ...grpc.CallOption) (*DeleteSensorResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type SensorServiceServer interface {
	...
	UpdateSensor(context.Context, *UpdateSensorRequest) (*Sensor, error)
	DeleteSensor(context.Context, *SensorId) (*DeleteSensorResponse, error)
...
func (UnimplementedSensorServiceServer) CreateSensor(context.Context, *CreateSensorRequest) (*Sensor, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateSensor not implemented")
}
func (UnimplementedSensorServiceServer) GetSensor(context.Context, *SensorId) (*Sensor, error) {
...
func (UnimplementedSensorServiceServer) UpdateSensor(context.Context, *UpdateSensorRequest) (*Sensor, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateSensor not implemented")
}
func (UnimplementedSensorServiceServer) DeleteSensor(context.Context, *SensorId) (*DeleteSensorResponse, error) {
...
func _SensorService_GetSensor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SensorServiceServer).GetSensor(ctx, req.(*SensorId))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SensorService_DeleteSensor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SensorServiceServer).DeleteSensor(ctx, req.(*SensorId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SensorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "benchlab.sensor.v1.SensorService",
